...
let kCircleHeightBackground: CGFloat = 90.0
...
public class SCLAlertView: UIViewController {
    ...
    let kCircleHeight: CGFloat = 80.0
    let kCircleIconHeight: CGFloat = 40.0
    ...
    required public init() {
        ...
        // Content View
        contentView.backgroundColor = UIColorFromRGB(0x242C33)
        ...
        labelTitle.font = Fonts.navTitle
        ...
        viewText.font = Fonts.cellSubtitle
        // Colours
        circleBG.backgroundColor = UIColorFromRGB(0x242C33)
        contentView.backgroundColor = UIColorFromRGB(0x242C33)
        labelTitle.textColor = UIColorFromRGB(0xFFFFFF)
        viewText.textColor = UIColorFromRGB(0xFFFFFF)
    ...
    override public func viewWillLayoutSubviews() {
        ...
        var y = (sz.height - windowHeight - (kCircleHeight / 8)) / 2 + 10
        ...
        let titleOffset : CGFloat = showCircularIcon ? 0.0 : -22.0
        ...
        for txt in inputs {
            txt.frame = CGRect(x:12, y:y, width:kWindowWidth - 24, height:kTextFieldHeight-10)
            txt.layer.cornerRadius = fieldCornerRadius
            y += kTextFieldHeight
        }
        // Buttons
        for btn in buttons {
            btn.frame = CGRect(x:12, y:y, width:kWindowWidth - 24, height:kButtonHeight-10)
    ...
    public func showTitle(title: String, subTitle: String, duration: NSTimeInterval?, completeText: String?, style: SCLAlertViewStyle, colorStyle: UInt?=0x000000, colorTextButton: UInt?=0xFFFFFF, circleIconImage: UIImage? = nil) -> SCLAlertViewResponder {
        ...
        for btn in buttons {
            if btn.titleLabel?.text == "Find Friends" {
...
class SCLAlertViewStyleKit : NSObject {
    ...
    class func drawEdit() {
        // Color Declarations
        let color = Colors.barBackground
